  ...
  return (
    <main className="flex flex-col items-center w-full h-[100%] overflow-scroll hideScrollbar">
      <div className="flex flex-col h-fit w-fit mb-[20px] animate__animated animate__fadeIn">
        ...
        <p className="mt-3 text-lg text-left md:mt-10 md:text-3xl">
          Business inquiries?
        </p>
        <p className="my-3 text-lg text-left md:my-10 md:text-3xl">
          <strong>Let us know.</strong>
        </p>

        <form
          className="roundedFormOppositeShadow max-w-[1500px] min-w-[300px]"
          onSubmit={sendEmail}
        >
          ...
          <div className="flex flex-col md:items-center items-left justify-left md:justify-around md:flex-row">
            <input
              ...
              type="text"
              placeholder="Name"
              className="md:w-[48%] w-[95%] p-2 mt-2 border-2 rounded-3xl border-slate-300"
            />
            <input
              name="user_email"
              type="text"
          ...
          <textarea
            name="message"
            placeholder="Message"
            className="resize-none md:w-[100%] w-[95%] h-[10rem] md:h-[14rem] p-2 my-2 border-2 rounded-3xl border-slate-300"
          />
